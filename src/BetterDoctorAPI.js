export class BetterDoctorAPI{
  getSearches(name, symptom, perPage) {
    return new Promise(function(resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?name=${name}&query=${symptom}&location=or-portland&sort=best-match-asc&skip=0&limit=${perPage}&user_key=${process.env.exports.apiKey}`;
